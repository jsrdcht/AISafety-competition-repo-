...
for steps, (input, label) in bar:
    ...
    Adv_img, _, _ = deepfool(model_resnet, model_densenet, input)
    # if steps==0: print(Adv_img[0])
...
images1, labels1 = np.concatenate(images, axis=0), np.concatenate(labels, axis=0)
...
np.save('./deepfool_data.npy', images)
np.save('./deepfool_label.npy', labels)
